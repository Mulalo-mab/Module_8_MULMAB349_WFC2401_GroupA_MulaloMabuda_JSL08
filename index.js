...
class BankBranch {
    constructor(branchInfo) {
        ...
        if (!BankBranch.bankBranchInstance) {
            // If bankBranchInstance doesn't exist, create a new instance
            // and assign the provided branchInfo to it
    ...
    // Method to get the branch information
    getBranchInfo() {
